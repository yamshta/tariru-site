...
LOCALES = {
    "ja": {
        ...
        "og_locale": "ja_JP",
        "label": "日本語",
        # title / description は App Store の name/subtitle と語彙を揃える
        # （残高確認・固定費・サブスク管理 — ASO keywords を web 検索でも拾う）
        "title": "TARIRU — 今月の支払い、足りる？｜残高確認・固定費・サブスク管理",
        "description": "給料日前の「今月、足りる？」を、口座残高と支払い予定からひと目で判定する iOS アプリ。残高確認・固定費・サブスクの引き落とし管理はこれひとつ。銀行連携なし、1円単位の記録も不要。家計簿が続かなくても大丈夫。",
        # Hero
        ...
        "features": [
            ...
            ("口座もカードも、ひとつに", "銀行口座・現金・クレジットカード・口座振替の残高確認を、ひとつの画面で。"),
            ("固定費とサブスクは自動で", "家賃・光熱費・サブスク・給与など毎月の収支は、一度設定すれば自動で登録されます。"),
